...
impl AttentionState {
    pub fn priority(self) -> u8 {
        ...
        match self {
            ...
            AttentionState::NoProgress => 2,
            AttentionState::JustFinished => 3,
            AttentionState::Working => 4,
            AttentionState::IdleShort => 5,
            AttentionState::IdleLong => 6,
            AttentionState::Fresh => 7,
            AttentionState::Stale => 8,
            AttentionState::Unknown => 9,
        }
    }
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            AttentionState::NoProgress => "quiet",
